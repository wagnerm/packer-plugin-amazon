...
type FlatCPUOptions struct {
	CoreCount      *int64 `mapstructure:"core_count" required:"false" cty:"core_count" hcl:"core_count"`
	ThreadsPerCore *int64 `mapstructure:"threads_per_core" required:"false" cty:"threads_per_core" hcl:"threads_per_core"`
}
