...
type FlatConfig struct {
	...
	CPUOptions                                *common.FlatCPUOptions                      `mapstructure:"cpu_options" required:"false" cty:"cpu_options" hcl:"cpu_options"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"cpu_options":                     &hcldec.BlockSpec{TypeName: "cpu_options", Nested: hcldec.ObjectSpec((*common.FlatCPUOptions)(nil).HCL2Spec())},
